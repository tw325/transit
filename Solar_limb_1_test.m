...
solar_limb_nonlinear = (solar_limb_psf.^nW)./(L50W^nW+solar_limb_psf.^nW);
venus_nonlinear = (venus_psf.^nB)./(L50B^nB+venus_psf.^nB);
stimulus_neur = solar_limb_nonlinear - (1 - venus_nonlinear);
...
%%
figure(100);clf
figure(100);subplot(2,2,1);imagesc(stim_orig_psf);colormap(gray);axis square
figure(100);subplot(2,2,2);imagesc(stimulus_orig);colormap(gray);axis square
figure(100);subplot(2,2,3);plot(stim_orig_psf(:,imSize/2),'r');axis square;hold on;plot(stimulus_orig(:,imSize/2),'k')
figure(100);subplot(2,2,4);plot(stim_orig_psf(:,imSize/2)-stimulus_orig(:,imSize/2),'r');axis square