...
%close all
clear all
%WORKS WITHOUT SATURATION
%WHITE RING AROUND VENUS --> ILLUSION????
nW = 10; %n of Sun (n>7)
L50W = .01; %L50 of Sun (same as l50b-change sigma for better view)
amp = 2; %saturation of Sun 
ampB=1; %saturation of Linear Venus 
ampBNL=-2; %saturation of Nonlinear Venus 
nB =1; %n of Venus (<=1.3)
L50B = 0.01; %L50 of Venus (<= 0.03)
...
sigma = 60;    % gaussian standard deviation in pixels (originally 80)
...
% theta = 0;    % grating orientation
sigma = 5;    % gaussian standard deviation in pixels (originally 3)
...
gaussWNLBNL = gaussWNLBNL(20:150,20:150);
...
%[0.02,0.05],0.05
figure(4);
subplot(1,2,1);imagesc( gaussWNLBNL, [-1 1] ); colormap('gray'); axis on; axis image;%axis on; title('White Nonlinear Black Nonlinear');
